...
return StyleSheet.create({
  ...
  topBarCancelBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 12, borderWidth: 1, borderColor: C.border2, backgroundColor: 'transparent' },
  topBarCancelText:{ fontSize: 13, fontWeight: '700', color: C.txt2 },
  topBarSaveBtn:   { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12, backgroundColor: C.accent2 },
  topBarSaveText:  { fontSize: 13, fontWeight: '800', color: C.txt },
